# WaveDumpReader: Read data produced by CAEN digitizers using the WaveDump 
# program. Code written by Tom Langford 
...
class DataFile:
    ...
    def getNextTrigger(self):
        ...
        #return trigger #ORIGINAL CODE, UNCOMMENT IF YOU FUCK UP 
        return trigger.triggerTime 
